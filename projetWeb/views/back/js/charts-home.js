...
var fev = parseInt(document.getElementById("fev").value);
var mar = parseInt(document.getElementById("mar").value);
var avr = parseInt(document.getElementById("avr").value);
var mai = parseInt(document.getElementById("mai").value);
            ...
            datasets: [
                {
                    ...
                    pointRadius: 1,
                    pointHitRadius: 0,
                    data: [jan, fev, mar, avr, mai, jun, jul, aug, sep, oct, nov, dec],
                    spanGaps: false
                }
